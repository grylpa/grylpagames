...
const LEVELS: Array = [
	...
	{"id": 4, "name": "Tricky",  "left": "prime",    "right": "convex",   "num_belts": 1, "belt_spd": 65.0, "robot_answer_time": 1.3, "min_examples": 5, "rounds": 4, "num_options": 4},
	{"id": 5, "name": "Expert",  "left": "lines",    "right": "even_odd", "num_belts": 2, "belt_spd": 70.0, "robot_answer_time": 1.2, "min_examples": 5, "rounds": 4, "num_options": 5},
]
