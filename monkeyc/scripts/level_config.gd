...
const LEVELS: Array = [
	{"id": 1, "name": "Simple",  "rules": ["digit", "square"],                                  
		"num_belts": 1, "belt_spd": 55.0, "robot_answer_time": 5.0, "min_examples": 4, "rounds": 3, "num_options": 2},
	{"id": 2, "name": "Even",    "rules": ["even_odd", "vowel", "hollow"],                       
		"num_belts": 1, "belt_spd": 60.0, "robot_answer_time": 2.6, "min_examples": 4, "rounds": 3, "num_options": 3},
	{"id": 3, "name": "Two",     "rules": ["hollow", "vowel", "even_odd", "square"],             
		"num_belts": 2, "belt_spd": 60.0, "robot_answer_time": 1.4, "min_examples": 4, "rounds": 3, "num_options": 4},
	{"id": 4, "name": "Tricky",  "rules": ["prime", "filled", "vowel", "lines", "color_shape"],       
		"num_belts": 1, "belt_spd": 65.0, "robot_answer_time": 1.2, "min_examples": 5, "rounds": 4, "num_options": 4},
	{"id": 5, "name": "Expert",  "rules": ["lines", "hollow", "prime", "color_shape", "stroop", "vowel"], 
		"num_belts": 2, "belt_spd": 70.0, "robot_answer_time": 1.0, "min_examples": 5, "rounds": 4, "num_options": 5},
]
