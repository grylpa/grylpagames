...
const LEVELS: Array = [
	...
	{"id": 3, "name": "Red",    "left": "prime",    "right": "convex",     "hide_after": 4, "rounds": 12, "window_dur": 2.3, "belt_spd": 75},
	{"id": 4, "name": "Cyan",   "left": "stroop",   "right": "color_shape","hide_after": 3, "rounds": 15, "window_dur": 2.0, "belt_spd": 80},
	{"id": 5, "name": "Orange", "left": "lines",    "right": "even_odd",   "hide_after": 2, "rounds": 15, "window_dur": 1.7, "belt_spd": 85},
]
