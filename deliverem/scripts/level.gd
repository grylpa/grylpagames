...
func level_is_done(didwin: bool):
	...
	if didwin:
		...
		# meant the board changed under the player every single time they finished one.
		round_in_level += 1
